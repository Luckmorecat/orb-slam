...
#include "Thirdparty/opencv-3.4/modules/core/include/opencv2/core/utils/trace.hpp"
#include "Thirdparty/opencv-3.4/modules/ts/include/opencv2/ts/ts_gtest.h"
namespace cv {
namespace hal {
#include "Thirdparty/opencv-3.4/modules/core/test/test_intrin_utils.hpp"
}
}
#endif
...
#define EMSCRIPTEN_CV_RECT(type, name) \
    emscripten::value_object<cv::Rect_<type>> (name) \
        ...
        emscripten::function("exceptionFromPtr", &binding_utils::exceptionFromPtr, allow_raw_pointers());
        ...
        emscripten::function("floodFill", select_overload<int(cv::Mat&, cv::Mat&, Point, Scalar, emscripten::val, Scalar, Scalar, int)>(&binding_utils::floodFill_wrapper));

        emscripten::function("floodFill", select_overload<int(cv::Mat&, cv::Mat&, Point, Scalar, emscripten::val, Scalar, Scalar)>(&binding_utils::floodFill_wrapper_1));

        emscripten::function("floodFill", select_overload<int(cv::Mat&, cv::Mat&, Point, Scalar, emscripten::val, Scalar)>(&binding_utils::floodFill_wrapper_2));

        emscripten::function("floodFill", select_overload<int(cv::Mat&, cv::Mat&, Point, Scalar, emscripten::val)>(&binding_utils::floodFill_wrapper_3));

        emscripten::function("floodFill", select_overload<int(cv::Mat&, cv::Mat&, Point, Scalar)>(&binding_utils::floodFill_wrapper_4));
#endif
        ...
        emscripten::function("parallel_pthreads_get_threads_num", &cv::parallel_pthreads_get_threads_num);
#endif

#ifdef TEST_WASM_INTRIN
        function("test_hal_intrin_uint8", &binding_utils::test_hal_intrin_uint8);
        emscripten::function("test_hal_intrin_int8", &binding_utils::test_hal_intrin_int8);
        emscripten::function("test_hal_intrin_uint16", &binding_utils::test_hal_intrin_uint16);
        emscripten::function("test_hal_intrin_int16", &binding_utils::test_hal_intrin_int16);
        emscripten::function("test_hal_intrin_uint32", &binding_utils::test_hal_intrin_uint32);
        emscripten::function("test_hal_intrin_int32", &binding_utils::test_hal_intrin_int32);
        emscripten::function("test_hal_intrin_uint64", &binding_utils::test_hal_intrin_uint64);
        emscripten::function("test_hal_intrin_int64", &binding_utils::test_hal_intrin_int64);
        emscripten::function("test_hal_intrin_float32", &binding_utils::test_hal_intrin_float32);
        emscripten::function("test_hal_intrin_float64", &binding_utils::test_hal_intrin_float64);
        emscripten::function("test_hal_intrin_all", &binding_utils::test_hal_intrin_all);
#endif
...
EMSCRIPTEN_BINDINGS(testBinding) {
        ...
        emscripten::function("Canny", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, bool)>(&Wrappers::Canny_wrapper));

        emscripten::function("Canny", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int)>(&Wrappers::Canny_wrapper_1));

        emscripten::function("Canny", select_overload<void(const cv::Mat&, cv::Mat&, double, double)>(&Wrappers::Canny_wrapper_2));

        emscripten::function("Canny1", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double, double, bool)>(&Wrappers::Canny_wrapper1));

        emscripten::function("Canny1", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double, double)>(&Wrappers::Canny_wrapper1_1));

        emscripten::function("GaussianBlur", select_overload<void(const cv::Mat&, cv::Mat&, Size, double, double, int)>(&Wrappers::GaussianBlur_wrapper));

        emscripten::function("GaussianBlur", select_overload<void(const cv::Mat&, cv::Mat&, Size, double, double)>(&Wrappers::GaussianBlur_wrapper_1));

        emscripten::function("GaussianBlur", select_overload<void(const cv::Mat&, cv::Mat&, Size, double)>(&Wrappers::GaussianBlur_wrapper_2));

        emscripten::function("HoughCircles", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, double, double, int, int)>(&Wrappers::HoughCircles_wrapper));

        emscripten::function("HoughCircles", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, double, double, int)>(&Wrappers::HoughCircles_wrapper_1));

        emscripten::function("HoughCircles", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, double, double)>(&Wrappers::HoughCircles_wrapper_2));

        emscripten::function("HoughCircles", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, double)>(&Wrappers::HoughCircles_wrapper_3));

        emscripten::function("HoughCircles", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double)>(&Wrappers::HoughCircles_wrapper_4));

        emscripten::function("HoughLines", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, double, double, double, double)>(&Wrappers::HoughLines_wrapper));

        emscripten::function("HoughLines", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, double, double, double)>(&Wrappers::HoughLines_wrapper_1));

        emscripten::function("HoughLines", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, double, double)>(&Wrappers::HoughLines_wrapper_2));

        emscripten::function("HoughLines", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, double)>(&Wrappers::HoughLines_wrapper_3));

        emscripten::function("HoughLines", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int)>(&Wrappers::HoughLines_wrapper_4));

        emscripten::function("HoughLinesP", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, double, double)>(&Wrappers::HoughLinesP_wrapper));

        emscripten::function("HoughLinesP", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, double)>(&Wrappers::HoughLinesP_wrapper_1));

        emscripten::function("HoughLinesP", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int)>(&Wrappers::HoughLinesP_wrapper_2));

        emscripten::function("Laplacian", select_overload<void(const cv::Mat&, cv::Mat&, int, int, double, double, int)>(&Wrappers::Laplacian_wrapper));

        emscripten::function("Laplacian", select_overload<void(const cv::Mat&, cv::Mat&, int, int, double, double)>(&Wrappers::Laplacian_wrapper_1));

        emscripten::function("Laplacian", select_overload<void(const cv::Mat&, cv::Mat&, int, int, double)>(&Wrappers::Laplacian_wrapper_2));

        emscripten::function("Laplacian", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::Laplacian_wrapper_3));

        emscripten::function("Laplacian", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::Laplacian_wrapper_4));

        emscripten::function("Rodrigues", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::Rodrigues_wrapper));

        emscripten::function("Rodrigues", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::Rodrigues_wrapper_1));

        emscripten::function("Scharr", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, double, double, int)>(&Wrappers::Scharr_wrapper));

        emscripten::function("Scharr", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, double, double)>(&Wrappers::Scharr_wrapper_1));

        emscripten::function("Scharr", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, double)>(&Wrappers::Scharr_wrapper_2));

        emscripten::function("Scharr", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int)>(&Wrappers::Scharr_wrapper_3));

        emscripten::function("Sobel", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, int, double, double, int)>(&Wrappers::Sobel_wrapper));

        emscripten::function("Sobel", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, int, double, double)>(&Wrappers::Sobel_wrapper_1));

        emscripten::function("Sobel", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, int, double)>(&Wrappers::Sobel_wrapper_2));

        emscripten::function("Sobel", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, int)>(&Wrappers::Sobel_wrapper_3));

        emscripten::function("Sobel", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int)>(&Wrappers::Sobel_wrapper_4));

        emscripten::function("absdiff", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::absdiff_wrapper));

        emscripten::function("adaptiveThreshold", select_overload<void(const cv::Mat&, cv::Mat&, double, int, int, int, double)>(&Wrappers::adaptiveThreshold_wrapper));

        emscripten::function("add", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&, int)>(&Wrappers::add_wrapper));

        emscripten::function("add", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::add_wrapper_1));

        emscripten::function("add", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::add_wrapper_2));

        emscripten::function("addWeighted", select_overload<void(const cv::Mat&, double, const cv::Mat&, double, double, cv::Mat&, int)>(&Wrappers::addWeighted_wrapper));

        emscripten::function("addWeighted", select_overload<void(const cv::Mat&, double, const cv::Mat&, double, double, cv::Mat&)>(&Wrappers::addWeighted_wrapper_1));

        emscripten::function("approxPolyDP", select_overload<void(const cv::Mat&, cv::Mat&, double, bool)>(&Wrappers::approxPolyDP_wrapper));

        emscripten::function("arcLength", select_overload<double(const cv::Mat&, bool)>(&Wrappers::arcLength_wrapper));

        emscripten::function("bilateralFilter", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, int)>(&Wrappers::bilateralFilter_wrapper));

        emscripten::function("bilateralFilter", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double)>(&Wrappers::bilateralFilter_wrapper_1));

        emscripten::function("bitwise_and", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::bitwise_and_wrapper));

        emscripten::function("bitwise_and", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::bitwise_and_wrapper_1));

        emscripten::function("bitwise_not", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::bitwise_not_wrapper));

        emscripten::function("bitwise_not", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::bitwise_not_wrapper_1));

        emscripten::function("bitwise_or", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::bitwise_or_wrapper));

        emscripten::function("bitwise_or", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::bitwise_or_wrapper_1));

        emscripten::function("bitwise_xor", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::bitwise_xor_wrapper));

        emscripten::function("bitwise_xor", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::bitwise_xor_wrapper_1));

        emscripten::function("blur", select_overload<void(const cv::Mat&, cv::Mat&, Size, Point, int)>(&Wrappers::blur_wrapper));

        emscripten::function("blur", select_overload<void(const cv::Mat&, cv::Mat&, Size, Point)>(&Wrappers::blur_wrapper_1));

        emscripten::function("blur", select_overload<void(const cv::Mat&, cv::Mat&, Size)>(&Wrappers::blur_wrapper_2));

        emscripten::function("boundingRect", select_overload<Rect(const cv::Mat&)>(&Wrappers::boundingRect_wrapper));

        emscripten::function("boxFilter", select_overload<void(const cv::Mat&, cv::Mat&, int, Size, Point, bool, int)>(&Wrappers::boxFilter_wrapper));

        emscripten::function("boxFilter", select_overload<void(const cv::Mat&, cv::Mat&, int, Size, Point, bool)>(&Wrappers::boxFilter_wrapper_1));

        emscripten::function("boxFilter", select_overload<void(const cv::Mat&, cv::Mat&, int, Size, Point)>(&Wrappers::boxFilter_wrapper_2));

        emscripten::function("boxFilter", select_overload<void(const cv::Mat&, cv::Mat&, int, Size)>(&Wrappers::boxFilter_wrapper_3));

        emscripten::function("calcBackProject", select_overload<void(const std::vector<cv::Mat>&, const emscripten::val&, const cv::Mat&, cv::Mat&, const emscripten::val&, double)>(&Wrappers::calcBackProject_wrapper));

        emscripten::function("calcHist", select_overload<void(const std::vector<cv::Mat>&, const emscripten::val&, const cv::Mat&, cv::Mat&, const emscripten::val&, const emscripten::val&, bool)>(&Wrappers::calcHist_wrapper));

        emscripten::function("calcHist", select_overload<void(const std::vector<cv::Mat>&, const emscripten::val&, const cv::Mat&, cv::Mat&, const emscripten::val&, const emscripten::val&)>(&Wrappers::calcHist_wrapper_1));

        emscripten::function("calcOpticalFlowFarneback", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double, int, int, int, int, double, int)>(&Wrappers::calcOpticalFlowFarneback_wrapper));

        emscripten::function("calcOpticalFlowPyrLK", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, Size, int, TermCriteria, int, double)>(&Wrappers::calcOpticalFlowPyrLK_wrapper));

        emscripten::function("calcOpticalFlowPyrLK", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, Size, int, TermCriteria, int)>(&Wrappers::calcOpticalFlowPyrLK_wrapper_1));

        emscripten::function("calcOpticalFlowPyrLK", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, Size, int, TermCriteria)>(&Wrappers::calcOpticalFlowPyrLK_wrapper_2));

        emscripten::function("calcOpticalFlowPyrLK", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, Size, int)>(&Wrappers::calcOpticalFlowPyrLK_wrapper_3));

        emscripten::function("calcOpticalFlowPyrLK", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, Size)>(&Wrappers::calcOpticalFlowPyrLK_wrapper_4));

        emscripten::function("calcOpticalFlowPyrLK", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::calcOpticalFlowPyrLK_wrapper_5));

        emscripten::function("cartToPolar", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, bool)>(&Wrappers::cartToPolar_wrapper));

        emscripten::function("cartToPolar", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::cartToPolar_wrapper_1));

        emscripten::function("circle", select_overload<void(cv::Mat&, Point, int, const Scalar&, int, int, int)>(&Wrappers::circle_wrapper));

        emscripten::function("circle", select_overload<void(cv::Mat&, Point, int, const Scalar&, int, int)>(&Wrappers::circle_wrapper_1));

        emscripten::function("circle", select_overload<void(cv::Mat&, Point, int, const Scalar&, int)>(&Wrappers::circle_wrapper_2));

        emscripten::function("circle", select_overload<void(cv::Mat&, Point, int, const Scalar&)>(&Wrappers::circle_wrapper_3));

        emscripten::function("compare", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, int)>(&Wrappers::compare_wrapper));

        emscripten::function("compareHist", select_overload<double(const cv::Mat&, const cv::Mat&, int)>(&Wrappers::compareHist_wrapper));

        emscripten::function("connectedComponents", select_overload<int(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::connectedComponents_wrapper));

        emscripten::function("connectedComponents", select_overload<int(const cv::Mat&, cv::Mat&, int)>(&Wrappers::connectedComponents_wrapper_1));

        emscripten::function("connectedComponents", select_overload<int(const cv::Mat&, cv::Mat&)>(&Wrappers::connectedComponents_wrapper_2));

        emscripten::function("connectedComponentsWithStats", select_overload<int(const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, int, int)>(&Wrappers::connectedComponentsWithStats_wrapper));

        emscripten::function("connectedComponentsWithStats", select_overload<int(const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&, int)>(&Wrappers::connectedComponentsWithStats_wrapper_1));

        emscripten::function("connectedComponentsWithStats", select_overload<int(const cv::Mat&, cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::connectedComponentsWithStats_wrapper_2));

        emscripten::function("contourArea", select_overload<double(const cv::Mat&, bool)>(&Wrappers::contourArea_wrapper));

        emscripten::function("contourArea", select_overload<double(const cv::Mat&)>(&Wrappers::contourArea_wrapper_1));

        emscripten::function("convertScaleAbs", select_overload<void(const cv::Mat&, cv::Mat&, double, double)>(&Wrappers::convertScaleAbs_wrapper));

        emscripten::function("convertScaleAbs", select_overload<void(const cv::Mat&, cv::Mat&, double)>(&Wrappers::convertScaleAbs_wrapper_1));

        emscripten::function("convertScaleAbs", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::convertScaleAbs_wrapper_2));

        emscripten::function("convexHull", select_overload<void(const cv::Mat&, cv::Mat&, bool, bool)>(&Wrappers::convexHull_wrapper));

        emscripten::function("convexHull", select_overload<void(const cv::Mat&, cv::Mat&, bool)>(&Wrappers::convexHull_wrapper_1));

        emscripten::function("convexHull", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::convexHull_wrapper_2));

        emscripten::function("convexityDefects", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::convexityDefects_wrapper));

        emscripten::function("copyMakeBorder", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, int, int, const Scalar&)>(&Wrappers::copyMakeBorder_wrapper));

        emscripten::function("copyMakeBorder", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int, int, int)>(&Wrappers::copyMakeBorder_wrapper_1));

        emscripten::function("cornerHarris", select_overload<void(const cv::Mat&, cv::Mat&, int, int, double, int)>(&Wrappers::cornerHarris_wrapper));

        emscripten::function("cornerHarris", select_overload<void(const cv::Mat&, cv::Mat&, int, int, double)>(&Wrappers::cornerHarris_wrapper_1));

        emscripten::function("cornerMinEigenVal", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int)>(&Wrappers::cornerMinEigenVal_wrapper));

        emscripten::function("cornerMinEigenVal", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::cornerMinEigenVal_wrapper_1));

        emscripten::function("cornerMinEigenVal", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::cornerMinEigenVal_wrapper_2));

        emscripten::function("countNonZero", select_overload<int(const cv::Mat&)>(&Wrappers::countNonZero_wrapper));

        emscripten::function("cvtColor", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::cvtColor_wrapper));

        emscripten::function("cvtColor", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::cvtColor_wrapper_1));

        emscripten::function("demosaicing", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::demosaicing_wrapper));

        emscripten::function("demosaicing", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::demosaicing_wrapper_1));

        emscripten::function("determinant", select_overload<double(const cv::Mat&)>(&Wrappers::determinant_wrapper));

        emscripten::function("dft", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::dft_wrapper));

        emscripten::function("dft", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::dft_wrapper_1));

        emscripten::function("dft", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::dft_wrapper_2));

        emscripten::function("dilate", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point, int, int, const Scalar&)>(&Wrappers::dilate_wrapper));

        emscripten::function("dilate", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point, int, int)>(&Wrappers::dilate_wrapper_1));

        emscripten::function("dilate", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point, int)>(&Wrappers::dilate_wrapper_2));

        emscripten::function("dilate", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point)>(&Wrappers::dilate_wrapper_3));

        emscripten::function("dilate", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::dilate_wrapper_4));

        emscripten::function("distanceTransform", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int)>(&Wrappers::distanceTransform_wrapper));

        emscripten::function("distanceTransform", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::distanceTransform_wrapper_1));

        emscripten::function("distanceTransformWithLabels", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&, int, int, int)>(&Wrappers::distanceTransformWithLabels_wrapper));

        emscripten::function("distanceTransformWithLabels", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&, int, int)>(&Wrappers::distanceTransformWithLabels_wrapper_1));

        emscripten::function("divide", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double, int)>(&Wrappers::divide_wrapper));

        emscripten::function("divide", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double)>(&Wrappers::divide_wrapper_1));

        emscripten::function("divide", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::divide_wrapper_2));

        emscripten::function("divide1", select_overload<void(double, const cv::Mat&, cv::Mat&, int)>(&Wrappers::divide_wrapper1));

        emscripten::function("divide1", select_overload<void(double, const cv::Mat&, cv::Mat&)>(&Wrappers::divide_wrapper1_1));

        emscripten::function("drawContours", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, int, const Scalar&, int, int, const cv::Mat&, int, Point)>(&Wrappers::drawContours_wrapper));

        emscripten::function("drawContours", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, int, const Scalar&, int, int, const cv::Mat&, int)>(&Wrappers::drawContours_wrapper_1));

        emscripten::function("drawContours", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, int, const Scalar&, int, int, const cv::Mat&)>(&Wrappers::drawContours_wrapper_2));

        emscripten::function("drawContours", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, int, const Scalar&, int, int)>(&Wrappers::drawContours_wrapper_3));

        emscripten::function("drawContours", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, int, const Scalar&, int)>(&Wrappers::drawContours_wrapper_4));

        emscripten::function("drawContours", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, int, const Scalar&)>(&Wrappers::drawContours_wrapper_5));

        emscripten::function("drawKeypoints", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, cv::Mat&, const Scalar&, int)>(&Wrappers::drawKeypoints_wrapper));

        emscripten::function("drawKeypoints", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, cv::Mat&, const Scalar&)>(&Wrappers::drawKeypoints_wrapper_1));

        emscripten::function("drawKeypoints", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, cv::Mat&)>(&Wrappers::drawKeypoints_wrapper_2));

        emscripten::function("drawMatches", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<DMatch>&, cv::Mat&, const Scalar&, const Scalar&, const emscripten::val&, int)>(&Wrappers::drawMatches_wrapper));

        emscripten::function("drawMatches", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<DMatch>&, cv::Mat&, const Scalar&, const Scalar&, const emscripten::val&)>(&Wrappers::drawMatches_wrapper_1));

        emscripten::function("drawMatches", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<DMatch>&, cv::Mat&, const Scalar&, const Scalar&)>(&Wrappers::drawMatches_wrapper_2));

        emscripten::function("drawMatches", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<DMatch>&, cv::Mat&, const Scalar&)>(&Wrappers::drawMatches_wrapper_3));

        emscripten::function("drawMatches", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<DMatch>&, cv::Mat&)>(&Wrappers::drawMatches_wrapper_4));

        emscripten::function("drawMatchesKnn", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<std::vector<DMatch>>&, cv::Mat&, const Scalar&, const Scalar&, const std::vector<std::vector<char>>&, int)>(&Wrappers::drawMatchesKnn_wrapper));

        emscripten::function("drawMatchesKnn", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<std::vector<DMatch>>&, cv::Mat&, const Scalar&, const Scalar&, const std::vector<std::vector<char>>&)>(&Wrappers::drawMatchesKnn_wrapper_1));

        emscripten::function("drawMatchesKnn", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<std::vector<DMatch>>&, cv::Mat&, const Scalar&, const Scalar&)>(&Wrappers::drawMatchesKnn_wrapper_2));

        emscripten::function("drawMatchesKnn", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<std::vector<DMatch>>&, cv::Mat&, const Scalar&)>(&Wrappers::drawMatchesKnn_wrapper_3));

        emscripten::function("drawMatchesKnn", select_overload<void(const cv::Mat&, const std::vector<KeyPoint>&, const cv::Mat&, const std::vector<KeyPoint>&, const std::vector<std::vector<DMatch>>&, cv::Mat&)>(&Wrappers::drawMatchesKnn_wrapper_4));

        emscripten::function("eigen", select_overload<bool(const cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::eigen_wrapper));

        emscripten::function("eigen", select_overload<bool(const cv::Mat&, cv::Mat&)>(&Wrappers::eigen_wrapper_1));

        emscripten::function("ellipse", select_overload<void(cv::Mat&, Point, Size, double, double, double, const Scalar&, int, int, int)>(&Wrappers::ellipse_wrapper));

        emscripten::function("ellipse", select_overload<void(cv::Mat&, Point, Size, double, double, double, const Scalar&, int, int)>(&Wrappers::ellipse_wrapper_1));

        emscripten::function("ellipse", select_overload<void(cv::Mat&, Point, Size, double, double, double, const Scalar&, int)>(&Wrappers::ellipse_wrapper_2));

        emscripten::function("ellipse", select_overload<void(cv::Mat&, Point, Size, double, double, double, const Scalar&)>(&Wrappers::ellipse_wrapper_3));

        emscripten::function("ellipse1", select_overload<void(cv::Mat&, const RotatedRect&, const Scalar&, int, int)>(&Wrappers::ellipse_wrapper1));

        emscripten::function("ellipse1", select_overload<void(cv::Mat&, const RotatedRect&, const Scalar&, int)>(&Wrappers::ellipse_wrapper1_1));

        emscripten::function("ellipse1", select_overload<void(cv::Mat&, const RotatedRect&, const Scalar&)>(&Wrappers::ellipse_wrapper1_2));

        emscripten::function("ellipse2Poly", select_overload<void(Point, Size, int, int, int, int, std::vector<Point>&)>(&Wrappers::ellipse2Poly_wrapper));

        emscripten::function("equalizeHist", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::equalizeHist_wrapper));

        emscripten::function("erode", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point, int, int, const Scalar&)>(&Wrappers::erode_wrapper));

        emscripten::function("erode", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point, int, int)>(&Wrappers::erode_wrapper_1));

        emscripten::function("erode", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point, int)>(&Wrappers::erode_wrapper_2));

        emscripten::function("erode", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Point)>(&Wrappers::erode_wrapper_3));

        emscripten::function("erode", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::erode_wrapper_4));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&, cv::Mat&, int, double, size_t, double, size_t)>(&Wrappers::estimateAffine2D_wrapper));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&, cv::Mat&, int, double, size_t, double)>(&Wrappers::estimateAffine2D_wrapper_1));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&, cv::Mat&, int, double, size_t)>(&Wrappers::estimateAffine2D_wrapper_2));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&, cv::Mat&, int, double)>(&Wrappers::estimateAffine2D_wrapper_3));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&, cv::Mat&, int)>(&Wrappers::estimateAffine2D_wrapper_4));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::estimateAffine2D_wrapper_5));

        emscripten::function("estimateAffine2D", select_overload<Mat(const cv::Mat&, const cv::Mat&)>(&Wrappers::estimateAffine2D_wrapper_6));

        emscripten::function("exp", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::exp_wrapper));

        emscripten::function("fillConvexPoly", select_overload<void(cv::Mat&, const cv::Mat&, const Scalar&, int, int)>(&Wrappers::fillConvexPoly_wrapper));

        emscripten::function("fillConvexPoly", select_overload<void(cv::Mat&, const cv::Mat&, const Scalar&, int)>(&Wrappers::fillConvexPoly_wrapper_1));

        emscripten::function("fillConvexPoly", select_overload<void(cv::Mat&, const cv::Mat&, const Scalar&)>(&Wrappers::fillConvexPoly_wrapper_2));

        emscripten::function("fillPoly", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, const Scalar&, int, int, Point)>(&Wrappers::fillPoly_wrapper));

        emscripten::function("fillPoly", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, const Scalar&, int, int)>(&Wrappers::fillPoly_wrapper_1));

        emscripten::function("fillPoly", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, const Scalar&, int)>(&Wrappers::fillPoly_wrapper_2));

        emscripten::function("fillPoly", select_overload<void(cv::Mat&, const std::vector<cv::Mat>&, const Scalar&)>(&Wrappers::fillPoly_wrapper_3));

        emscripten::function("filter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point, double, int)>(&Wrappers::filter2D_wrapper));

        emscripten::function("filter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point, double)>(&Wrappers::filter2D_wrapper_1));

        emscripten::function("filter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point)>(&Wrappers::filter2D_wrapper_2));

        emscripten::function("filter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&)>(&Wrappers::filter2D_wrapper_3));

        emscripten::function("findContours", select_overload<void(cv::Mat&, std::vector<cv::Mat>&, cv::Mat&, int, int, Point)>(&Wrappers::findContours_wrapper));

        emscripten::function("findContours", select_overload<void(cv::Mat&, std::vector<cv::Mat>&, cv::Mat&, int, int)>(&Wrappers::findContours_wrapper_1));

        emscripten::function("findHomography", select_overload<Mat(const cv::Mat&, const cv::Mat&, int, double, cv::Mat&, const int, const double)>(&Wrappers::findHomography_wrapper));

        emscripten::function("findHomography", select_overload<Mat(const cv::Mat&, const cv::Mat&, int, double, cv::Mat&, const int)>(&Wrappers::findHomography_wrapper_1));

        emscripten::function("findHomography", select_overload<Mat(const cv::Mat&, const cv::Mat&, int, double, cv::Mat&)>(&Wrappers::findHomography_wrapper_2));

        emscripten::function("findHomography", select_overload<Mat(const cv::Mat&, const cv::Mat&, int, double)>(&Wrappers::findHomography_wrapper_3));

        emscripten::function("findHomography", select_overload<Mat(const cv::Mat&, const cv::Mat&, int)>(&Wrappers::findHomography_wrapper_4));

        emscripten::function("findHomography", select_overload<Mat(const cv::Mat&, const cv::Mat&)>(&Wrappers::findHomography_wrapper_5));

        emscripten::function("findTransformECC", select_overload<double(const cv::Mat&, const cv::Mat&, cv::Mat&, int, TermCriteria, const cv::Mat&, int)>(&Wrappers::findTransformECC_wrapper));

        emscripten::function("fitEllipse", select_overload<RotatedRect(const cv::Mat&)>(&Wrappers::fitEllipse_wrapper));

        emscripten::function("fitLine", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, double)>(&Wrappers::fitLine_wrapper));

        emscripten::function("flip", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::flip_wrapper));

        emscripten::function("gemm", select_overload<void(const cv::Mat&, const cv::Mat&, double, const cv::Mat&, double, cv::Mat&, int)>(&Wrappers::gemm_wrapper));

        emscripten::function("gemm", select_overload<void(const cv::Mat&, const cv::Mat&, double, const cv::Mat&, double, cv::Mat&)>(&Wrappers::gemm_wrapper_1));

        emscripten::function("getAffineTransform", select_overload<Mat(const cv::Mat&, const cv::Mat&)>(&Wrappers::getAffineTransform_wrapper));

        emscripten::function("getOptimalDFTSize", select_overload<int(int)>(&Wrappers::getOptimalDFTSize_wrapper));

        emscripten::function("getPerspectiveTransform", select_overload<Mat(const cv::Mat&, const cv::Mat&)>(&Wrappers::getPerspectiveTransform_wrapper));

        emscripten::function("getRotationMatrix2D", select_overload<Mat(Point2f, double, double)>(&Wrappers::getRotationMatrix2D_wrapper));

        emscripten::function("getStructuringElement", select_overload<Mat(int, Size, Point)>(&Wrappers::getStructuringElement_wrapper));

        emscripten::function("getStructuringElement", select_overload<Mat(int, Size)>(&Wrappers::getStructuringElement_wrapper_1));

        emscripten::function("goodFeaturesToTrack", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&, int, bool, double)>(&Wrappers::goodFeaturesToTrack_wrapper));

        emscripten::function("goodFeaturesToTrack", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&, int, bool)>(&Wrappers::goodFeaturesToTrack_wrapper_1));

        emscripten::function("goodFeaturesToTrack", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&, int)>(&Wrappers::goodFeaturesToTrack_wrapper_2));

        emscripten::function("goodFeaturesToTrack", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&)>(&Wrappers::goodFeaturesToTrack_wrapper_3));

        emscripten::function("goodFeaturesToTrack", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double)>(&Wrappers::goodFeaturesToTrack_wrapper_4));

        emscripten::function("goodFeaturesToTrack1", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&, int, int, bool, double)>(&Wrappers::goodFeaturesToTrack_wrapper1));

        emscripten::function("goodFeaturesToTrack1", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&, int, int, bool)>(&Wrappers::goodFeaturesToTrack_wrapper1_1));

        emscripten::function("goodFeaturesToTrack1", select_overload<void(const cv::Mat&, cv::Mat&, int, double, double, const cv::Mat&, int, int)>(&Wrappers::goodFeaturesToTrack_wrapper1_2));

        emscripten::function("grabCut", select_overload<void(const cv::Mat&, cv::Mat&, Rect, cv::Mat&, cv::Mat&, int, int)>(&Wrappers::grabCut_wrapper));

        emscripten::function("grabCut", select_overload<void(const cv::Mat&, cv::Mat&, Rect, cv::Mat&, cv::Mat&, int)>(&Wrappers::grabCut_wrapper_1));

        emscripten::function("groupRectangles", select_overload<void(std::vector<Rect>&, std::vector<int>&, int, double)>(&Wrappers::groupRectangles_wrapper));

        emscripten::function("groupRectangles", select_overload<void(std::vector<Rect>&, std::vector<int>&, int)>(&Wrappers::groupRectangles_wrapper_1));

        emscripten::function("hconcat", select_overload<void(const std::vector<cv::Mat>&, cv::Mat&)>(&Wrappers::hconcat_wrapper));

        emscripten::function("inRange", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::inRange_wrapper));

        emscripten::function("initUndistortRectifyMap", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, const cv::Mat&, Size, int, cv::Mat&, cv::Mat&)>(&Wrappers::initUndistortRectifyMap_wrapper));

        emscripten::function("integral", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::integral_wrapper));

        emscripten::function("integral", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::integral_wrapper_1));

        emscripten::function("integral2", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&, int, int)>(&Wrappers::integral2_wrapper));

        emscripten::function("integral2", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&, int)>(&Wrappers::integral2_wrapper_1));

        emscripten::function("integral2", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::integral2_wrapper_2));

        emscripten::function("invert", select_overload<double(const cv::Mat&, cv::Mat&, int)>(&Wrappers::invert_wrapper));

        emscripten::function("invert", select_overload<double(const cv::Mat&, cv::Mat&)>(&Wrappers::invert_wrapper_1));

        emscripten::function("isContourConvex", select_overload<bool(const cv::Mat&)>(&Wrappers::isContourConvex_wrapper));

        emscripten::function("kmeans", select_overload<double(const cv::Mat&, int, cv::Mat&, TermCriteria, int, int, cv::Mat&)>(&Wrappers::kmeans_wrapper));

        emscripten::function("kmeans", select_overload<double(const cv::Mat&, int, cv::Mat&, TermCriteria, int, int)>(&Wrappers::kmeans_wrapper_1));

        emscripten::function("line", select_overload<void(cv::Mat&, Point, Point, const Scalar&, int, int, int)>(&Wrappers::line_wrapper));

        emscripten::function("line", select_overload<void(cv::Mat&, Point, Point, const Scalar&, int, int)>(&Wrappers::line_wrapper_1));

        emscripten::function("line", select_overload<void(cv::Mat&, Point, Point, const Scalar&, int)>(&Wrappers::line_wrapper_2));

        emscripten::function("line", select_overload<void(cv::Mat&, Point, Point, const Scalar&)>(&Wrappers::line_wrapper_3));

        emscripten::function("log", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::log_wrapper));

        emscripten::function("magnitude", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::magnitude_wrapper));

        emscripten::function("matchShapes", select_overload<double(const cv::Mat&, const cv::Mat&, int, double)>(&Wrappers::matchShapes_wrapper));

        emscripten::function("matchTemplate", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, int, const cv::Mat&)>(&Wrappers::matchTemplate_wrapper));

        emscripten::function("matchTemplate", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, int)>(&Wrappers::matchTemplate_wrapper_1));

        emscripten::function("max", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::max_wrapper));

        emscripten::function("mean", select_overload<Scalar(const cv::Mat&, const cv::Mat&)>(&Wrappers::mean_wrapper));

        emscripten::function("mean", select_overload<Scalar(const cv::Mat&)>(&Wrappers::mean_wrapper_1));

        emscripten::function("meanStdDev", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::meanStdDev_wrapper));

        emscripten::function("meanStdDev", select_overload<void(const cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::meanStdDev_wrapper_1));

        emscripten::function("medianBlur", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::medianBlur_wrapper));

        emscripten::function("merge", select_overload<void(const std::vector<cv::Mat>&, cv::Mat&)>(&Wrappers::merge_wrapper));

        emscripten::function("min", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::min_wrapper));

        emscripten::function("minAreaRect", select_overload<RotatedRect(const cv::Mat&)>(&Wrappers::minAreaRect_wrapper));

        emscripten::function("mixChannels", select_overload<void(const std::vector<cv::Mat>&, std::vector<cv::Mat>&, const emscripten::val&)>(&Wrappers::mixChannels_wrapper));

        emscripten::function("moments", select_overload<Moments(const cv::Mat&, bool)>(&Wrappers::moments_wrapper));

        emscripten::function("moments", select_overload<Moments(const cv::Mat&)>(&Wrappers::moments_wrapper_1));

        emscripten::function("morphologyEx", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point, int, int, const Scalar&)>(&Wrappers::morphologyEx_wrapper));

        emscripten::function("morphologyEx", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point, int, int)>(&Wrappers::morphologyEx_wrapper_1));

        emscripten::function("morphologyEx", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point, int)>(&Wrappers::morphologyEx_wrapper_2));

        emscripten::function("morphologyEx", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, Point)>(&Wrappers::morphologyEx_wrapper_3));

        emscripten::function("morphologyEx", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&)>(&Wrappers::morphologyEx_wrapper_4));

        emscripten::function("multiply", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double, int)>(&Wrappers::multiply_wrapper));

        emscripten::function("multiply", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, double)>(&Wrappers::multiply_wrapper_1));

        emscripten::function("multiply", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::multiply_wrapper_2));

        emscripten::function("norm", select_overload<double(const cv::Mat&, int, const cv::Mat&)>(&Wrappers::norm_wrapper));

        emscripten::function("norm", select_overload<double(const cv::Mat&, int)>(&Wrappers::norm_wrapper_1));

        emscripten::function("norm", select_overload<double(const cv::Mat&)>(&Wrappers::norm_wrapper_2));

        emscripten::function("norm1", select_overload<double(const cv::Mat&, const cv::Mat&, int, const cv::Mat&)>(&Wrappers::norm_wrapper1));

        emscripten::function("norm1", select_overload<double(const cv::Mat&, const cv::Mat&, int)>(&Wrappers::norm_wrapper1_1));

        emscripten::function("norm1", select_overload<double(const cv::Mat&, const cv::Mat&)>(&Wrappers::norm_wrapper1_2));

        emscripten::function("normalize", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, int, const cv::Mat&)>(&Wrappers::normalize_wrapper));

        emscripten::function("normalize", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int, int)>(&Wrappers::normalize_wrapper_1));

        emscripten::function("normalize", select_overload<void(const cv::Mat&, cv::Mat&, double, double, int)>(&Wrappers::normalize_wrapper_2));

        emscripten::function("normalize", select_overload<void(const cv::Mat&, cv::Mat&, double, double)>(&Wrappers::normalize_wrapper_3));

        emscripten::function("normalize", select_overload<void(const cv::Mat&, cv::Mat&, double)>(&Wrappers::normalize_wrapper_4));

        emscripten::function("normalize", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::normalize_wrapper_5));

        emscripten::function("perspectiveTransform", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::perspectiveTransform_wrapper));

        emscripten::function("pointPolygonTest", select_overload<double(const cv::Mat&, Point2f, bool)>(&Wrappers::pointPolygonTest_wrapper));

        emscripten::function("polarToCart", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&, bool)>(&Wrappers::polarToCart_wrapper));

        emscripten::function("polarToCart", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, cv::Mat&)>(&Wrappers::polarToCart_wrapper_1));

        emscripten::function("pow", select_overload<void(const cv::Mat&, double, cv::Mat&)>(&Wrappers::pow_wrapper));

        emscripten::function("putText", select_overload<void(cv::Mat&, const std::string&, Point, int, double, Scalar, int, int, bool)>(&Wrappers::putText_wrapper));

        emscripten::function("putText", select_overload<void(cv::Mat&, const std::string&, Point, int, double, Scalar, int, int)>(&Wrappers::putText_wrapper_1));

        emscripten::function("putText", select_overload<void(cv::Mat&, const std::string&, Point, int, double, Scalar, int)>(&Wrappers::putText_wrapper_2));

        emscripten::function("putText", select_overload<void(cv::Mat&, const std::string&, Point, int, double, Scalar)>(&Wrappers::putText_wrapper_3));

        emscripten::function("pyrDown", select_overload<void(const cv::Mat&, cv::Mat&, const Size&, int)>(&Wrappers::pyrDown_wrapper));

        emscripten::function("pyrDown", select_overload<void(const cv::Mat&, cv::Mat&, const Size&)>(&Wrappers::pyrDown_wrapper_1));

        emscripten::function("pyrDown", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::pyrDown_wrapper_2));

        emscripten::function("pyrUp", select_overload<void(const cv::Mat&, cv::Mat&, const Size&, int)>(&Wrappers::pyrUp_wrapper));

        emscripten::function("pyrUp", select_overload<void(const cv::Mat&, cv::Mat&, const Size&)>(&Wrappers::pyrUp_wrapper_1));

        emscripten::function("pyrUp", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::pyrUp_wrapper_2));

        emscripten::function("randn", select_overload<void(cv::Mat&, const cv::Mat&, const cv::Mat&)>(&Wrappers::randn_wrapper));

        emscripten::function("randu", select_overload<void(cv::Mat&, const cv::Mat&, const cv::Mat&)>(&Wrappers::randu_wrapper));

        emscripten::function("rectangle", select_overload<void(cv::Mat&, Point, Point, const Scalar&, int, int, int)>(&Wrappers::rectangle_wrapper));

        emscripten::function("rectangle", select_overload<void(cv::Mat&, Point, Point, const Scalar&, int, int)>(&Wrappers::rectangle_wrapper_1));

        emscripten::function("rectangle", select_overload<void(cv::Mat&, Point, Point, const Scalar&, int)>(&Wrappers::rectangle_wrapper_2));

        emscripten::function("rectangle", select_overload<void(cv::Mat&, Point, Point, const Scalar&)>(&Wrappers::rectangle_wrapper_3));

        emscripten::function("reduce", select_overload<void(const cv::Mat&, cv::Mat&, int, int, int)>(&Wrappers::reduce_wrapper));

        emscripten::function("reduce", select_overload<void(const cv::Mat&, cv::Mat&, int, int)>(&Wrappers::reduce_wrapper_1));

        emscripten::function("remap", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, const cv::Mat&, int, int, const Scalar&)>(&Wrappers::remap_wrapper));

        emscripten::function("remap", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, const cv::Mat&, int, int)>(&Wrappers::remap_wrapper_1));

        emscripten::function("remap", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, const cv::Mat&, int)>(&Wrappers::remap_wrapper_2));

        emscripten::function("repeat", select_overload<void(const cv::Mat&, int, int, cv::Mat&)>(&Wrappers::repeat_wrapper));

        emscripten::function("resize", select_overload<void(const cv::Mat&, cv::Mat&, Size, double, double, int)>(&Wrappers::resize_wrapper));

        emscripten::function("resize", select_overload<void(const cv::Mat&, cv::Mat&, Size, double, double)>(&Wrappers::resize_wrapper_1));

        emscripten::function("resize", select_overload<void(const cv::Mat&, cv::Mat&, Size, double)>(&Wrappers::resize_wrapper_2));

        emscripten::function("resize", select_overload<void(const cv::Mat&, cv::Mat&, Size)>(&Wrappers::resize_wrapper_3));

        emscripten::function("rotate", select_overload<void(const cv::Mat&, cv::Mat&, int)>(&Wrappers::rotate_wrapper));

        emscripten::function("sepFilter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, const cv::Mat&, Point, double, int)>(&Wrappers::sepFilter2D_wrapper));

        emscripten::function("sepFilter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, const cv::Mat&, Point, double)>(&Wrappers::sepFilter2D_wrapper_1));

        emscripten::function("sepFilter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, const cv::Mat&, Point)>(&Wrappers::sepFilter2D_wrapper_2));

        emscripten::function("sepFilter2D", select_overload<void(const cv::Mat&, cv::Mat&, int, const cv::Mat&, const cv::Mat&)>(&Wrappers::sepFilter2D_wrapper_3));

        emscripten::function("setIdentity", select_overload<void(cv::Mat&, const Scalar&)>(&Wrappers::setIdentity_wrapper));

        emscripten::function("setIdentity", select_overload<void(cv::Mat&)>(&Wrappers::setIdentity_wrapper_1));

        emscripten::function("setRNGSeed", select_overload<void(int)>(&Wrappers::setRNGSeed_wrapper));

        emscripten::function("solve", select_overload<bool(const cv::Mat&, const cv::Mat&, cv::Mat&, int)>(&Wrappers::solve_wrapper));

        emscripten::function("solve", select_overload<bool(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::solve_wrapper_1));

        emscripten::function("solvePoly", select_overload<double(const cv::Mat&, cv::Mat&, int)>(&Wrappers::solvePoly_wrapper));

        emscripten::function("solvePoly", select_overload<double(const cv::Mat&, cv::Mat&)>(&Wrappers::solvePoly_wrapper_1));

        emscripten::function("split", select_overload<void(const cv::Mat&, std::vector<cv::Mat>&)>(&Wrappers::split_wrapper));

        emscripten::function("sqrt", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::sqrt_wrapper));

        emscripten::function("subtract", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&, int)>(&Wrappers::subtract_wrapper));

        emscripten::function("subtract", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::subtract_wrapper_1));

        emscripten::function("subtract", select_overload<void(const cv::Mat&, const cv::Mat&, cv::Mat&)>(&Wrappers::subtract_wrapper_2));

        emscripten::function("threshold", select_overload<double(const cv::Mat&, cv::Mat&, double, double, int)>(&Wrappers::threshold_wrapper));

        emscripten::function("trace", select_overload<Scalar(const cv::Mat&)>(&Wrappers::trace_wrapper));

        emscripten::function("transform", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&)>(&Wrappers::transform_wrapper));

        emscripten::function("transpose", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::transpose_wrapper));

        emscripten::function("undistort", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, const cv::Mat&, const cv::Mat&)>(&Wrappers::undistort_wrapper));

        emscripten::function("undistort", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, const cv::Mat&)>(&Wrappers::undistort_wrapper_1));

        emscripten::function("vconcat", select_overload<void(const std::vector<cv::Mat>&, cv::Mat&)>(&Wrappers::vconcat_wrapper));

        emscripten::function("warpAffine", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size, int, int, const Scalar&)>(&Wrappers::warpAffine_wrapper));

        emscripten::function("warpAffine", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size, int, int)>(&Wrappers::warpAffine_wrapper_1));

        emscripten::function("warpAffine", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size, int)>(&Wrappers::warpAffine_wrapper_2));

        emscripten::function("warpAffine", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size)>(&Wrappers::warpAffine_wrapper_3));

        emscripten::function("warpPerspective", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size, int, int, const Scalar&)>(&Wrappers::warpPerspective_wrapper));

        emscripten::function("warpPerspective", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size, int, int)>(&Wrappers::warpPerspective_wrapper_1));

        emscripten::function("warpPerspective", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size, int)>(&Wrappers::warpPerspective_wrapper_2));

        emscripten::function("warpPerspective", select_overload<void(const cv::Mat&, cv::Mat&, const cv::Mat&, Size)>(&Wrappers::warpPerspective_wrapper_3));

        emscripten::function("warpPolar", select_overload<void(const cv::Mat&, cv::Mat&, Size, Point2f, double, int)>(&Wrappers::warpPolar_wrapper));

        emscripten::function("watershed", select_overload<void(const cv::Mat&, cv::Mat&)>(&Wrappers::watershed_wrapper));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&, double, const Size&, const Scalar&, bool, bool, int)>(&Wrappers::blobFromImage_wrapper));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&, double, const Size&, const Scalar&, bool, bool)>(&Wrappers::blobFromImage_wrapper_1));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&, double, const Size&, const Scalar&, bool)>(&Wrappers::blobFromImage_wrapper_2));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&, double, const Size&, const Scalar&)>(&Wrappers::blobFromImage_wrapper_3));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&, double, const Size&)>(&Wrappers::blobFromImage_wrapper_4));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&, double)>(&Wrappers::blobFromImage_wrapper_5));

        emscripten::function("blobFromImage", select_overload<Mat(const cv::Mat&)>(&Wrappers::blobFromImage_wrapper_6));

        emscripten::function("readNet", select_overload<Net(const std::string&, const std::string&, const std::string&)>(&Wrappers::readNet_wrapper));

        emscripten::function("readNet", select_overload<Net(const std::string&, const std::string&)>(&Wrappers::readNet_wrapper_1));

        emscripten::function("readNet", select_overload<Net(const std::string&)>(&Wrappers::readNet_wrapper_2));

        emscripten::function("readNet1", select_overload<Net(const std::string&, const emscripten::val&, const emscripten::val&)>(&Wrappers::readNet_wrapper1));

        emscripten::function("readNet1", select_overload<Net(const std::string&, const emscripten::val&)>(&Wrappers::readNet_wrapper1_1));

        emscripten::function("readNetFromCaffe", select_overload<Net(const std::string&, const std::string&)>(&Wrappers::readNetFromCaffe_wrapper));

        emscripten::function("readNetFromCaffe", select_overload<Net(const std::string&)>(&Wrappers::readNetFromCaffe_wrapper_1));

        emscripten::function("readNetFromCaffe1", select_overload<Net(const emscripten::val&, const emscripten::val&)>(&Wrappers::readNetFromCaffe_wrapper1));

        emscripten::function("readNetFromCaffe1", select_overload<Net(const emscripten::val&)>(&Wrappers::readNetFromCaffe_wrapper1_1));

        emscripten::function("readNetFromDarknet", select_overload<Net(const std::string&, const std::string&)>(&Wrappers::readNetFromDarknet_wrapper));

        emscripten::function("readNetFromDarknet", select_overload<Net(const std::string&)>(&Wrappers::readNetFromDarknet_wrapper_1));

        emscripten::function("readNetFromDarknet1", select_overload<Net(const emscripten::val&, const emscripten::val&)>(&Wrappers::readNetFromDarknet_wrapper1));

        emscripten::function("readNetFromDarknet1", select_overload<Net(const emscripten::val&)>(&Wrappers::readNetFromDarknet_wrapper1_1));

        emscripten::function("readNetFromONNX", select_overload<Net(const std::string&)>(&Wrappers::readNetFromONNX_wrapper));

        emscripten::function("readNetFromONNX1", select_overload<Net(const emscripten::val&)>(&Wrappers::readNetFromONNX_wrapper1));

        emscripten::function("readNetFromTensorflow", select_overload<Net(const std::string&, const std::string&)>(&Wrappers::readNetFromTensorflow_wrapper));

        emscripten::function("readNetFromTensorflow", select_overload<Net(const std::string&)>(&Wrappers::readNetFromTensorflow_wrapper_1));

        emscripten::function("readNetFromTensorflow1", select_overload<Net(const emscripten::val&, const emscripten::val&)>(&Wrappers::readNetFromTensorflow_wrapper1));

        emscripten::function("readNetFromTensorflow1", select_overload<Net(const emscripten::val&)>(&Wrappers::readNetFromTensorflow_wrapper1_1));

        emscripten::function("readNetFromTorch", select_overload<Net(const std::string&, bool, bool)>(&Wrappers::readNetFromTorch_wrapper));

        emscripten::function("readNetFromTorch", select_overload<Net(const std::string&, bool)>(&Wrappers::readNetFromTorch_wrapper_1));

        emscripten::function("readNetFromTorch", select_overload<Net(const std::string&)>(&Wrappers::readNetFromTorch_wrapper_2));

        emscripten::function("initUndistortRectifyMap", select_overload<void(const cv::Mat&, const cv::Mat&, const cv::Mat&, const cv::Mat&, const Size&, int, cv::Mat&, cv::Mat&)>(&Wrappers::initUndistortRectifyMap_wrapper));
